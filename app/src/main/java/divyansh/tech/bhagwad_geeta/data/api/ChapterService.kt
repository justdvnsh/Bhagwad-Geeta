...
import divyansh.tech.bhagwad_geeta.data.models.Chapter.ChapterItem
import divyansh.tech.bhagwad_geeta.data.models.Verses.Verse
...
interface ChapterService {
    ...
    * @returns Response<ChapterDetails>
    * */
    @GET("/gita/{chap}/{verse}")
